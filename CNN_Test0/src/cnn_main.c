...
)
{
  ...
  for(i = 0; i < CNN_LAYER_NUM; ++i){
    free(cnn_layer_image[i].filter);
    free(cnn_layer_image[i].conv_out);
    free(cnn_layer_image[i].pool_out);
  }
  free(cnn_layer_image[0].input_data);
...
)
{
  ...
  // CNN Layer 0の設定
  cnn_layer_image[0].filter       = (double *)malloc(sizeof(double) *
  ...
  cnn_layer_image[0].input_data   = (double *)malloc(sizeof(double) *
  ...
  cnn_layer_image[0].conv_height  = cnn_layer_image[0].input_height -
                                    (2 * (cnn_layer_image[0].filter_size / 2));
  // 畳込みの領域確保
  cnn_layer_image[0].conv_out     = (double *)malloc(sizeof(double) *
  ...
  // プーリングの領域確保
  cnn_layer_image[0].pool_out     = (double *)malloc(sizeof(double) *
                                    cnn_layer_image[0].pool_width *
                                    cnn_layer_image[0].pool_height *
                                    cnn_layer_image[0].pool_depth);

  // CNN Layer 1の設定
  cnn_layer_image[1].filter       = (double *)malloc(sizeof(double) *
  ...
  cnn_layer_image[1].conv_height  = cnn_layer_image[1].input_height -
                                    (2 * (cnn_layer_image[1].filter_size / 2));
  // 畳込みの領域確保
  cnn_layer_image[1].conv_out     = (double *)malloc(sizeof(double) *
  ...
  // プーリングの領域確保
  cnn_layer_image[1].pool_out     = (double *)malloc(sizeof(double) *
                                    cnn_layer_image[1].pool_width *
                                    cnn_layer_image[1].pool_height *
                                    cnn_layer_image[1].pool_depth);

  // CNN Layer 2の設定
  cnn_layer_image[2].filter       = (double *)malloc(sizeof(double) *
  ...
  cnn_layer_image[2].conv_height  = cnn_layer_image[2].input_height -
                                    (2 * (cnn_layer_image[2].filter_size / 2));
  // 畳込みの領域確保
  cnn_layer_image[2].conv_out     = (double *)malloc(sizeof(double) *
  ...
  // プーリングの領域確保
  cnn_layer_image[2].pool_out     = (double *)malloc(sizeof(double) *
